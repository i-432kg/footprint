...
| 6 | 異常系 | ローカル部 | 長さ超過、許可外文字、ドット位置不正を拒否すること |
...
| 8 | 異常系 | ローカル部先頭ドットを拒否する | `".user@example.com"` | 例外 |  |
| 9 | 異常系 | ローカル部末尾ドットを拒否する | `"user.@example.com"` | 例外 |  |
| 10 | 異常系 | ローカル部連続ドットを拒否する | `"us..er@example.com"` | 例外 |  |
| 11 | 異常系 | ローカル部長さ超過を拒否する | 65文字超のローカル部 | 例外 |  |
| 12 | 異常系 | ドメイン部ドットなしを拒否する | `"user@example"` | 例外 |  |
| 13 | 異常系 | ドメイン部連続ドットを拒否する | `"user@example..com"` | 例外 |  |
| 14 | 異常系 | ドメイン部先頭末尾ドットを拒否する | `"user@.example.com"`, `"user@example.com."` | 例外 |  |
